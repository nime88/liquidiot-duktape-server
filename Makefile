...
_OBJ = duktape.o duk_print_alert.o duk_console.o duk_module_node.o c_eventloop.o http_server.o globals.o response.o node_module_search.o file_ops.o application.o applications_manager.o main.o
