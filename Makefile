...
INCLUDE=-I$(SOURCE_DIR) -I$(SOURCE_DIR)/nodejs -I$(DUKTAPE_DIR)/src -I$(DUKTAPE_EXTRAS)/print-alert -I$(DUKTAPE_EXTRAS)/module-node
# TODO: Currently build directory is not automatically generated
BUILD_DIR=build

_OBJ = duktape.o duk_print_alert.o duk_module_node.o c_eventloop.o node_module_search.o file_ops.o application.o applications_manager.o main.o
